...
public class BestPerformanceListActivity extends AppCompatActivity {

    SearchView searchView;
    RecyclerView rvBestPerformance;
    ...
    LinearLayout layoutDropDownCourses, layoutDropDownTest, layoutDropDownBattalion, disucssionFormDropDownLayout
            , myProfileLayout , changePasswordLayout;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_best_performance_list);
    ...
    {
        rvBestPerformance = findViewById(R.id.rvPerformanceList);
        rvBestPerformance.setLayoutManager(new LinearLayoutManager(this));
        rvBestPerformance.setAdapter(new AdapterBestPerformanceRecycler());
    }
    ...
    private void initViews() {
        ...
        myTest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(BestPerformanceListActivity.this, "My Tests", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        changePasswordLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(BestPerformanceListActivity.this, ChangePasswordActivity.class));
            }
        });
        ...
        myProfileLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(BestPerformanceListActivity.this, MyProfileActivity.class));
            }
        });
